function TripAdvisorIcon({className} : {className?: string}) {
    return ( <svg className={className} xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" version="1.1" id="Layer_3" x="0px" y="0px" width="72px" height="72px" viewBox="0 0 72 72" xmlSpace="preserve">
    <style type="text/css">
    </style>
    <path className="fill-[#34E0A1]" d="M72,36c0,19.9-16.1,36-36,36S0,55.9,0,36C0,16.1,16.1,0,36,0S72,16.1,72,36"/>
