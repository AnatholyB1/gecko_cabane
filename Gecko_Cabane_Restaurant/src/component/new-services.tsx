    ...
    return ( 
        <section className={cn(className,'grid place-items-center gap-[5rem]  place-content-center grid-flow-row py-[5rem] ')}>
            ...
            <div className="grid grid-flow-row gap-6 place-items-center px-5 col-span-2 lg:col-span-1 w-full h-full">
                <img  onClick={() => nav('/services')} className="transition-transform hover:scale-105 img text-center home-info-p w-[300px] h-[300px] md:w-[390px] md:h-[390px]"  data-recalc-dims="1" loading="eager" data-lazy-loaded="1" title="gecko-cabane-marketplace"  src="https://gecko-api-mbde.onrender.com/public//pexels-shantanu-pal-2802527.jpg" alt="oups something is missing" />
            ...
            <div className=" grid grid-flow-row gap-6 place-items-center px-5 col-span-2 lg:col-span-1 w-full h-full">
                <img onClick={() => nav('/services')} className="transition-transform hover:scale-105 img text-center home-info-p w-[300px] h-[300px] md:w-[390px] md:h-[390px]"   data-recalc-dims="1" loading="eager" data-lazy-loaded="1" title="gecko-cabane-course" decoding="async" src="https://gecko-api-mbde.onrender.com/public/cuisine.jpg" alt="oups something is missing" />
