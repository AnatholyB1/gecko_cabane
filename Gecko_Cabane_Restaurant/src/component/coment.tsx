    ...
    return (
            <section className={cn(className, 'grid place-items-center gap-[5rem] place-content-center grid-flow-row py-[5rem] ') }>
                ...
                <div className="grid  grid-flow-col gap-2 place-items-center col-span-2 w-full h-full">
                    <a title="Lonely PLanet" className="w-[3rem] h-[3rem] rounded-full duration-300 transition:transform hover:scale-150  " href="https://www.lonelyplanet.com/thailand/krabi-town/restaurants/gecko-cabane/a/poi-eat/1572474/357601"><FontAwesomeIcon color="blue" icon={faEarthAmericas} className="rounded-full w-full h-full fill-primary " /></a>
