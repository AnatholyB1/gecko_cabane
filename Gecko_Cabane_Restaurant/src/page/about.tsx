...
export default function About() {
    return <Layer>
            <section className="grid place-items-center grid-flow-row  bg-white py-[5rem] w-full">
                ...
                <Separator></Separator>
                <Card img="./src/assets/chef.jpg" title="Chef Jariya PAKLOW" orientation="left">
                    <div className="flex items-center justify-center gap-5 flex-col">
                        ...
                        <Button id="serviecs" className="flex gap-2 rounded-full transition delay-150 duration-300 hover:scale-110"><Link to="/services">MORE INFORMATION</Link><ChevronRight className="w-4 h-4 stokre-1"></ChevronRight></Button>
                    </div>
                </Card>
            </section>
        </Layer>
